        ...
        "file_list": [
            {
                ...
                "folderPath": "/myfolder1",
                "fullPath": "/volume1/myfolder1",
                "isValidSource": True,
                "missing": False,
            },
            {
                ...
                "fileSystem": "BTRFS",
                "fileSystemType": "internal",
                "folderPath": "/myfolder2",
                "fullPath": "/volume1/myfolder2",
                "isValidSource": True,
                "missing": False,
            },
        ],
...
SCHEDULE_VALID: Dict[str, Any] = {
    ...
    "schedule": {
        ...
        "last_work_hour": 13,
        "min": 0,
        "next_trigger_time": "2023-12-20 13:00",
        "repeat": 0,
        "repeat_hour": 0,
...
DSM_7_TASK_1_LIST_RUN_NO_SCHD_0_PCT: Dict[str, Any] = {
    ...
    "state": "backupable",
    "status": "backup",
    "last_bkp_result": "backingup",
    "data_enc": False,
    "data_type": "data",
    "ext3ShareList": [],
    "last_bkp_end_time": "2023/12/18 14:51",
    "last_bkp_time": "2023/12/18 14:51",
    "next_bkp_time": "",
    "repo_id": 1,
    "schedule": SCHEDULE_DISABLED,
    "target_id": "vault_5.hbk",
    "target_type": "image",
...
DSM_7_TASK_1_STATUS_RUN_NO_SCHD_0_PCT: Dict[str, Any] = {
    ...
    "data": {
        ...
        "last_bkp_progress": 73,
        "last_bkp_success_time": "2023/12/18 14:50",
        "last_bkp_time": "2023/12/18 14:51",
        "next_bkp_time": "",
        "schedule": SCHEDULE_DISABLED,
        "progress": {
            ...
            "can_suspend": False,
            "current_app": "",
            "current_app_action_percent": "0",
            "current_app_percent": "0",
            "current_app_stage": "",
            "processed_size": "0",
            "scan_file_count": "0",
            "title_type": "backingup",
            "total_size": "0",
            "transmitted_size": "0",
        },
    },
...
DSM_7_TASK_2_STATUS_RUN_NO_SCHD_84_PCT: Dict[str, Any] = {
    ...
    "data": {
        ...
        "progress": {
            ...
            "current_app_percent": "0",
            "current_app_stage": "",
            "processed_size": "1009875720",
            "scan_file_count": "16699",
            "title_type": "backingup",
            "total_size": "1202233000",
            "transmitted_size": "9789834655",
        },
    },
}
...
DSM_7_TASK_3_LIST_RUN_WITH_SCHD_SIZE_CNT: Dict[str, Any] = {
    ...
    "ext3ShareList": [],
    "is_modified": False,
    "last_bkp_end_time": "2023/12/19 13:12",
    "last_bkp_time": "2023/12/19 13:12",
    "repo_id": 3,
    "source": DUMMY_SOURCE_DATA,
    "target_id": "vault_4.hbk",
    "target_type": "image",
...
DSM_7_TASK_3_STATUS_RUN_WITH_SCHD_SIZE_CNT: Dict[str, Any] = {
    ...
    "data": {
        ...
        "status": "backup",
        "last_bkp_result": "backingup",
        "last_bkp_end_time": "2023/12/21 01:13",
        "last_bkp_error": "",
        "last_bkp_error_code": 4401,
        "last_bkp_success_time": "2023/12/21 01:12",
        "last_bkp_time": "2023/12/21 01:13",
        "next_bkp_time": "2023/12/22 01:00",
        "schedule": SCHEDULE_VALID,
        "progress": {
            "step": "total_size_count",
            "progress": 0,
            "app_done_list": [],
            "app_list": [],
            "avg_speed": 0,
...
DSM_7_TASK_4_LIST_BROKEN: Dict[str, Any] = {
    ...
    "ext3ShareList": [],
    "is_modified": False,
    "last_bkp_end_time": "2022/10/19 13:40",
    "last_bkp_time": "2022/10/19 13:40",
    "repo_id": 4,
    "source": DUMMY_SOURCE_DATA,
    "target_id": "vault_1.hbk",
...
DSM_7_TASK_4_STATUS_BROKEN: Dict[str, Any] = {
    ...
    "data": {
        ...
        "state": "restore_only",
        "last_bkp_result": "done",
        "last_bkp_error": "SYNO.SDS.Backup.Application:error:status_target_broken",
        "last_bkp_end_time": "2022/10/19 13:40",
        "last_bkp_error_code": 4467,
        "last_bkp_success_time": "2022/10/19 13:21",
        "last_bkp_time": "2022/10/19 13:40",
        "next_bkp_time": "",
        "schedule": SCHEDULE_DISABLED,
    },
...
DSM_7_TASK_6_LIST_IDLE_WITH_SCHEDULE: Dict[str, Any] = {
    ...
    "ext3ShareList": [],
    "is_modified": False,
    "last_bkp_end_time": "2023/12/19 01:16",
    "last_bkp_time": "2023/12/19 01:16",
    "repo_id": 6,
    "source": DUMMY_SOURCE_DATA,
    "target_id": "vault_2.hbk",
    "target_type": "image",
...
TARGET_DATA_ONLINE: Dict[str, Any] = {
    ...
    "data": {
        ...
        "data_enc": True,
        "format_type": "image",
        "host_name": "synology_nas",
        "is_online": True,
        "last_detect_time": "",
        "owner_id": 1040,
        "owner_name": "backup_user",
